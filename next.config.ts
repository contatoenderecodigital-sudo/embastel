    ...
    return [
      {
        ...
        headers: [
          ...
          // O Cache-Control do painel NÃO fica aqui: para página
          // pré-renderizada o Next define o dele e ignora o do config. Quem
          // faz isso é o src/proxy.ts, com o motivo explicado lá.
        ],
      },
    ];
  },
